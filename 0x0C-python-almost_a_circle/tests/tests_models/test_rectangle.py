#!/usr/bin/python3
""" unittests for testing models/rectangle.py.
...
class TestRectangle_stdout(unittest.TestCase):
    ...
    def capture_stdout(rect, method):
        """Captures and returns text printed to stdandard output.
        Args:
            rect (Rectangle): The Rectangle to print to stdout.
            method (str): The method to run on rect.
        Returns:
            The text printed to standard output by calling method on sq.
        """
        capture = io.StringIO()
        sys.stdout = capture
        if method == "print":
